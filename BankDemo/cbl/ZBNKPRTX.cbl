      ...
      *************************************************************** 
       ...
       01  AN-ARRAY. 
               05 ARRAY-ENTRY          PIC X(10) OCCURS 10 TIMES.
       01  ARRAY-INX                   PIC 99.
       PROCEDURE DIVISION.
       000-TOP-LEVEL.
           
           PERFORM 100-INITIALIZATION.
           MOVE 11 TO ARRAY-INX. 
           MOVE 'TESTING' TO ARRAY-ENTRY(ARRAY-INX). 
...
RJIV1      MOVE 'Y' TO FIRST-RECORD-SW. 
...
RJIV1      IF  NOT-FIRST-RECORD 
RJIV1          AND PR-RECORD-TYPE IS NOT EQUAL TO '2'
RJIV1              PERFORM 210-PROCESS-1-RECORDS. 
RJIV1      PERFORM 230-READ-A-RECORD.
RJIV1      MOVE 'N' TO FIRST-RECORD-SW. 
